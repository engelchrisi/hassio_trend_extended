"""Test the Trend Extended config flow."""
...
from homeassistant.components.trend_extended import async_setup_entry
...
async def test_form(hass: HomeAssistant) -> None:
    ...
    with patch(
        "homeassistant.components.trend_extended.async_setup_entry",
